...
impl SemanticIrDb {
    ...
    pub(super) fn new(packages: Vec<PackageIr>) -> Self {
        Self { packages }
    }
...
impl PackageIr {
    pub(super) fn new(targets: Vec<TargetIr>) -> Self {
        Self { targets }
    }
...
impl TargetIr {
    pub(super) fn new(local_def_count: usize) -> Self {
        Self {
